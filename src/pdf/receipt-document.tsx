      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.topRow}>
          ...
          <View style={styles.invoiceBlock}>
            <Text style={styles.invoiceLabel}>Bon</Text>
            <Text style={styles.invoiceNumber}>{receipt.receiptNumber}</Text>
          </View>
        </View>

        <View style={styles.infoBox}>
          <InfoColumnPdf title="Betalingsgegevens">
            <Text style={styles.infoText}>
              Betaaldatum: {formatDate(receipt.paymentDate)}
            </Text>
            <Text style={styles.infoText}>
              Betaalwijze: {receipt.paymentMethod}
            </Text>
            <Text style={styles.infoBold}>
              Betaald: {formatCurrency(receipt.total)}
            </Text>
          </InfoColumnPdf>
          ...
          <InfoColumnPdf title="Ontvangen van" last>
            <Text style={styles.infoBold}>{receipt.customerName}</Text>
            <Text style={styles.infoText}>ID: {receipt.identificationNumber}</Text>
            <Text style={styles.infoText}>{receipt.email}</Text>
            <Text style={styles.infoText}>Tel: {receipt.phone}</Text>
          </InfoColumnPdf>
        </View>
          ...
          <View style={styles.totalsBox}>
            ...
            <View style={styles.totalRow}>
              <Text style={styles.totalLabel}>
                BTW ({formatPercent(receipt.vatRate)})
              </Text>
              <Text style={styles.totalValue}>
            ...
            <View style={styles.balanceRow}>
              <Text style={styles.balanceLabel}>Betaald</Text>
        ...
        <Text style={styles.footer}>Bedankt voor uw betaling.</Text>
      </Page>
    </Document>
  );
}
